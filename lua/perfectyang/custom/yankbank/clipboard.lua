...
local utils = require("perfectyang.custom.yankbank.utils")
...
function M.add_yank(text, reg_type, pin)
  ...
  if #YB_YANKS > YB_OPTS.max_entries then
    ...
    if not i or i == 1 then
      ...
      print("Warning: all YankBank entries are pinned, insertion behavior is undefined when all entries are pinned.")
    else
