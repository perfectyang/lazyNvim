  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        -- keymap.set("n", "gl", "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
        -- --
        ...
        -- keymap.set("n", "<space>h", vim.lsp.buf.hover, opts) -- show documentation for what is under cursor
