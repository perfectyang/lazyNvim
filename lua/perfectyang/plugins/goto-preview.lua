...
--     -- vim.keymap.set("n", "gsc", "<cmd>lua require('goto-preview').dismiss_preview()<CR>", { noremap = true })
--     vim.keymap.set(
--       "n",
--       "gsc",
...
--       { noremap = true }
--     )
--     -- vim.keymap.set("n", "gsc", "<cmd>lua require('goto-preview').remove_win()<CR>", { noremap = true })
